...
HD_PWD='C:/Users/monke/Documents/GitHub/ReconHardware/PynqSoftware/input_output/input_output.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log io_switch_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source io_switch_wrapper.tcl
