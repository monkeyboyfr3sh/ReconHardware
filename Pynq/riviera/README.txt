...
#
# Generated by export_simulation on Sat Jun 13 14:26:10 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './XBar_tb.sh' script.

./XBar_tb.sh -reset_run
...
./XBar_tb.sh -noclean_files

For more information on the script, please type './XBar_tb.sh -help'.
