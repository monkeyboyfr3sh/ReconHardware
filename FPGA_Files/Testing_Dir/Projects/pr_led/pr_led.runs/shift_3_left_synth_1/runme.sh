...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Testing_Dir/Projects/pr_led/pr_led.runs/shift_3_left_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_3_left.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_3_left.tcl
