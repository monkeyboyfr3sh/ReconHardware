...
HD_PWD='D:/Adam/Documents/Vivado_Projects/SobelPTDemoReady/SobelPTDemoReady.runs/design_1_process_mod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_process_mod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_process_mod_0_0.tcl
