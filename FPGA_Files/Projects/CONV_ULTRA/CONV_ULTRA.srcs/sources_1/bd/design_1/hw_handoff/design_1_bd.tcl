...
proc create_root_design { parentCell } {
  ...
  set led [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 led ]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_ports led] [get_bd_pins led/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_gpio_o [get_bd_pins led/Din] [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o]
