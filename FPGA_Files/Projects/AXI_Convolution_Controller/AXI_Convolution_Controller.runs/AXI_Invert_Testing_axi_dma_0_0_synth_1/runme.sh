...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/AXI_Convolution_Controller/AXI_Convolution_Controller.runs/AXI_Invert_Testing_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Invert_Testing_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Invert_Testing_axi_dma_0_0.tcl
