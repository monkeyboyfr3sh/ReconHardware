...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/Convolution_Accelerator/Convolution_Accelerator.runs/design_2_axi_gpio_6_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axi_gpio_6_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axi_gpio_6_0.tcl
