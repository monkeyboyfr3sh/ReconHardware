...
proc create_root_design { parentCell } {
  ...
  set EMPTY_IN [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 EMPTY_IN ]

  set EMPTY_OUT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 EMPTY_OUT ]

  set FIXED_IO [ create_bd_intf_port -mode Master -vlnv xilinx.com:display_processing_system7:fixedio_rtl:1.0 FIXED_IO ]

  set FULL_IN [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 FULL_IN ]

  set FULL_OUT [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 FULL_OUT ]

  set Rst [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 Rst ]

  set bufferInput [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 bufferInput ]

  set buffered_conv_out [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 buffered_conv_out ]

  set cStart [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cStart ]

  set io_clk [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 io_clk ]

  set newline [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 newline ]

  set rd [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 rd ]

  set wr [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 wr ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_GPIO_EMIO_GPIO_IO {42} \
   CONFIG.PCW_GPIO_EMIO_GPIO_WIDTH {42} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports bufferInput] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_10_GPIO [get_bd_intf_ports FULL_OUT] [get_bd_intf_pins axi_gpio_10/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_11_GPIO [get_bd_intf_ports EMPTY_OUT] [get_bd_intf_pins axi_gpio_11/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports cStart] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports Rst] [get_bd_intf_pins axi_gpio_2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO [get_bd_intf_ports io_clk] [get_bd_intf_pins axi_gpio_3/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_4_GPIO [get_bd_intf_ports newline] [get_bd_intf_pins axi_gpio_4/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_5_GPIO [get_bd_intf_ports rd] [get_bd_intf_pins axi_gpio_5/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_6_GPIO [get_bd_intf_ports wr] [get_bd_intf_pins axi_gpio_6/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_7_GPIO [get_bd_intf_ports buffered_conv_out] [get_bd_intf_pins axi_gpio_7/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_8_GPIO [get_bd_intf_ports FULL_IN] [get_bd_intf_pins axi_gpio_8/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_9_GPIO [get_bd_intf_ports EMPTY_IN] [get_bd_intf_pins axi_gpio_9/GPIO]
  ...
  assign_bd_address -offset 0x41230000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_10/S_AXI/Reg] -force
  assign_bd_address -offset 0x41240000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_11/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x41250000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] -force
  assign_bd_address -offset 0x41260000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] -force
  assign_bd_address -offset 0x41270000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_4/S_AXI/Reg] -force
  assign_bd_address -offset 0x41280000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_5/S_AXI/Reg] -force
  assign_bd_address -offset 0x41290000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_6/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_7/S_AXI/Reg] -force
  assign_bd_address -offset 0x412A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_8/S_AXI/Reg] -force
  assign_bd_address -offset 0x412B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_9/S_AXI/Reg] -force
