...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/ConvolutionAccel_s/ConvolutionAccel_s.runs/Convolution_Controller_ila_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Convolution_Controller_ila_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Convolution_Controller_ila_0_2.tcl
