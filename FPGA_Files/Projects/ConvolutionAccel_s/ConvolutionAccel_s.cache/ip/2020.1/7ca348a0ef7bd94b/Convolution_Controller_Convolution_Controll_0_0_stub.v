...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(axi_clk, axi_reset_n, ip_reset_out, cSum, cReady, 
...
/* synthesis syn_black_box black_box_pad_pin="axi_clk,axi_reset_n,ip_reset_out,cSum[7:0],cReady,MULTIPLIER_INPUT[23:0],MULTIPLICAND_INPUT[23:0],MULTIPLY_START[2:0],FINALADDOUT,s_axis_valid,s_axis_data[7:0],s_axis_ready,s_axis_last,s_axis_keep[0:0],m_axis_valid,m_axis_data[7:0],m_axis_ready,m_axis_last,m_axis_keep[0:0],s_axi_awaddr[9:0],s_axi_awready,s_axi_awvalid,s_axi_wdata[31:0],s_axi_wready,s_axi_wvalid,s_axi_araddr[9:0],s_axi_arready,s_axi_arvalid,s_axi_rdata[31:0],s_axi_rready,s_axi_rvalid,s_axi_bvalid,s_axi_bready,s_axi_rlast" */;
  input axi_clk;
  input axi_reset_n;
  output ip_reset_out;
  input [7:0]cSum;
