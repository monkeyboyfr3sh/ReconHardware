...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(temp_in_data, temp_in_sig, axi_clk, 
  axi_reset_n, ip_reset_out, cSum, cReady, MULTIPLIER_INPUT, MULTIPLICAND_INPUT, 
  MULTIPLY_START, FINALADDOUT, s_axis_valid, s_axis_data, s_axis_ready, s_axis_last, 
