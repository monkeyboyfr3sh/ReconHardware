...
// Date        : Fri Mar  5 09:21:55 2021
// Host        : DESKTOP-D9F9TPQ running 64-bit major release  (build 9200)
// Command     : write_verilog -force -mode synth_stub
//               c:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.srcs/sources_1/bd/design_2/ip/design_2_dfx_controller_0_0/design_2_dfx_controller_0_0_stub.v
// Design      : design_2_dfx_controller_0_0
...
(* x_core_info = "dfx_controller_design_2_dfx_controller_0_0,Vivado 2020.1" *)
module design_2_dfx_controller_0_0(m_axi_mem_araddr, m_axi_mem_arlen, 
  ...
  icap_csib, icap_rdwrb, icap_i, icap_o, vsm_shifter_hw_triggers, 
  vsm_shifter_rm_shutdown_req, vsm_shifter_rm_shutdown_ack, vsm_shifter_rm_decouple, 
  vsm_shifter_rm_reset, vsm_shifter_event_error, vsm_shifter_sw_shutdown_req, 
  vsm_shifter_sw_startup_req, cap_req, cap_gnt, cap_rel, s_axi_reg_awaddr, s_axi_reg_awvalid, 
...
/* synthesis syn_black_box black_box_pad_pin="m_axi_mem_araddr[31:0],m_axi_mem_arlen[7:0],m_axi_mem_arsize[2:0],m_axi_mem_arburst[1:0],m_axi_mem_arprot[2:0],m_axi_mem_arcache[3:0],m_axi_mem_aruser[3:0],m_axi_mem_arvalid,m_axi_mem_arready,m_axi_mem_rdata[31:0],m_axi_mem_rresp[1:0],m_axi_mem_rlast,m_axi_mem_rvalid,m_axi_mem_rready,clk,reset,icap_clk,icap_reset,icap_csib,icap_rdwrb,icap_i[31:0],icap_o[31:0],vsm_shifter_hw_triggers[1:0],vsm_shifter_rm_shutdown_req,vsm_shifter_rm_shutdown_ack,vsm_shifter_rm_decouple,vsm_shifter_rm_reset,vsm_shifter_event_error,vsm_shifter_sw_shutdown_req,vsm_shifter_sw_startup_req,cap_req,cap_gnt,cap_rel,s_axi_reg_awaddr[31:0],s_axi_reg_awvalid,s_axi_reg_awready,s_axi_reg_wdata[31:0],s_axi_reg_wvalid,s_axi_reg_wready,s_axi_reg_bresp[1:0],s_axi_reg_bvalid,s_axi_reg_bready,s_axi_reg_araddr[31:0],s_axi_reg_arvalid,s_axi_reg_arready,s_axi_reg_rdata[31:0],s_axi_reg_rresp[1:0],s_axi_reg_rvalid,s_axi_reg_rready" */;
  ...
  input [31:0]icap_i;
  output [31:0]icap_o;
  input [1:0]vsm_shifter_hw_triggers;
  output vsm_shifter_rm_shutdown_req;
  input vsm_shifter_rm_shutdown_ack;
  output vsm_shifter_rm_decouple;
  output vsm_shifter_rm_reset;
