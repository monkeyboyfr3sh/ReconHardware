...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC000_ROUTE {0b10000011} \
   CONFIG.MSC001_ROUTE {0b10000101} \
   CONFIG.MSC002_ROUTE {0b10001001} \
   CONFIG.MSC003_ROUTE {0b10010001} \
   CONFIG.MSC004_ROUTE {0b10100001} \
   CONFIG.MSC005_ROUTE {0b11000001} \
