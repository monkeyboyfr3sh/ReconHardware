...
proc create_root_design { parentCell } {
  ...
  # Create instance: dfx_m_axi_ila_1, and set properties
  set dfx_m_axi_ila_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 dfx_m_axi_ila_1 ]
  set_property -dict [ list \
   CONFIG.C_TRIGIN_EN {true} \
   CONFIG.C_TRIGOUT_EN {true} \
 ] $dfx_m_axi_ila_1

  # Create instance: dfx_s_axi_ila_0, and set properties
  set dfx_s_axi_ila_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 dfx_s_axi_ila_0 ]
  set_property -dict [ list \
   CONFIG.C_TRIGIN_EN {false} \
   CONFIG.C_TRIGOUT_EN {true} \
 ] $dfx_s_axi_ila_0

  # Create instance: gpio_ila_3, and set properties
  set gpio_ila_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 gpio_ila_3 ]
  set_property -dict [ list \
   CONFIG.C_TRIGIN_EN {false} \
   CONFIG.C_TRIGOUT_EN {false} \
 ] $gpio_ila_3

  # Create instance: mem_int_ila_2, and set properties
  set mem_int_ila_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:ila:6.2 mem_int_ila_2 ]
  set_property -dict [ list \
   CONFIG.C_TRIGIN_EN {true} \
   CONFIG.C_TRIGOUT_EN {false} \
 ] $mem_int_ila_2
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_mem_intercon_M00_AXI] [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins mem_int_ila_2/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets dfx_controller_0_M_AXI_MEM] [get_bd_intf_pins dfx_controller_0/M_AXI_MEM] [get_bd_intf_pins dfx_m_axi_ila_1/SLOT_0_AXI]
  connect_bd_intf_net -intf_net dfx_m_axi_ila_1_TRIG_OUT [get_bd_intf_pins dfx_m_axi_ila_1/TRIG_OUT] [get_bd_intf_pins mem_int_ila_2/TRIG_IN]
  connect_bd_intf_net -intf_net dfx_s_axi_ila_0_TRIG_OUT [get_bd_intf_pins dfx_m_axi_ila_1/TRIG_IN] [get_bd_intf_pins dfx_s_axi_ila_0/TRIG_OUT]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M00_AXI] [get_bd_intf_pins dfx_s_axi_ila_0/SLOT_0_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps7_0_axi_periph_M01_AXI] [get_bd_intf_pins gpio_ila_3/SLOT_0_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0_0] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins dfx_controller_0/clk] [get_bd_pins dfx_controller_0/icap_clk] [get_bd_pins dfx_m_axi_ila_1/clk] [get_bd_pins dfx_s_axi_ila_0/clk] [get_bd_pins gpio_ila_3/clk] [get_bd_pins mem_int_ila_2/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins dfx_controller_0/icap_reset] [get_bd_pins dfx_controller_0/reset] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
