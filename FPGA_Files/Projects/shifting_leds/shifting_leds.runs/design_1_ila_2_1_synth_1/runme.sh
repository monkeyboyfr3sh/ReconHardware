...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.runs/design_1_ila_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ila_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ila_2_1.tcl
