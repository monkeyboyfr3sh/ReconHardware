...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.runs/design_2_dfx_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_dfx_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_dfx_controller_0_0.tcl
