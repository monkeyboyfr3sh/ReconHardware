...
namespace eval ::optrace {
  variable script "C:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.runs/synth_1/top.dcp
  ...
  set_property SCOPED_TO_CELLS shifter [get_files C:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.runs/shift_left_synth_1/shift_left.dcp]
  set_property netlist_only true [get_files C:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.runs/shift_left_synth_1/shift_left.dcp]
...
OPTRACE "route_design misc" START { }
  ...
  set_property HD.PLATFORM_WRAPPER 1 [get_cells shifter]
...
OPTRACE "write_bitstream" START { }
  ...
  write_bitstream -force -cell shifter shifter_shift_left_partial.bit -bin_file
...
OPTRACE "read constraints: write_bitstream_post" END { }
  ...
  catch {write_debug_probes -quiet -force -cell shifter -file shifter_shift_left_partial.ltx}
  update_design -cell shifter -black_box
  lock_design -level routing
  write_checkpoint -force top_routed_bb.dcp
