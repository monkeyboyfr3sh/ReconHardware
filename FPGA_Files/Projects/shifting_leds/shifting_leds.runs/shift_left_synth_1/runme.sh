...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/shifting_leds/shifting_leds.runs/shift_left_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_left.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shift_left.tcl
