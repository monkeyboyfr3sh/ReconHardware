...
proc create_root_design { parentCell } {
  ...
  set MULTIPLICAND_INPUT_0 [ create_bd_port -dir O -from 863 -to 0 MULTIPLICAND_INPUT_0 ]
  set MULTIPLIER_INPUT_0 [ create_bd_port -dir O -from 863 -to 0 MULTIPLIER_INPUT_0 ]
  set MULTIPLY_START_0 [ create_bd_port -dir O -from 8 -to 0 MULTIPLY_START_0 ]
  set cReady_0 [ create_bd_port -dir I -from 0 -to 0 cReady_0 ]
  set cSum_0 [ create_bd_port -dir I -from 31 -to 0 cSum_0 ]
  set vsm_ma_rm_reset_0 [ create_bd_port -dir O vsm_ma_rm_reset_0 ]
  ...
  # Create instance: snooper_0, and set properties
  set snooper_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:snooper:1.0 snooper_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets Convolution_Controll_0_m_axis_data] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins snooper_0/axis_port_1]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins snooper_0/axis_port_0]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets dfx_controller_0_M_AXI_MEM] [get_bd_intf_pins dfx_controller_0/M_AXI_MEM] [get_bd_intf_pins dfx_mem_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins Convolution_Controll_0/s_axi] [get_bd_intf_pins smartconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins dfx_controller_0/s_axi_reg] [get_bd_intf_pins smartconnect_0/M02_AXI]
  ...
  connect_bd_net -net Op1_0_1 [get_bd_ports cReady_0] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins snooper_0/axi_reset_n]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Convolution_Controll_0/axi_reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins dfx_controller_0/icap_reset] [get_bd_pins dfx_controller_0/reset] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net snooper_0_count [get_bd_pins ila_0/probe1] [get_bd_pins snooper_0/count]
  connect_bd_net -net snooper_0_fin [get_bd_pins ila_0/probe0] [get_bd_pins snooper_0/fin]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Convolution_Controll_0/s_axi/reg0] -force
