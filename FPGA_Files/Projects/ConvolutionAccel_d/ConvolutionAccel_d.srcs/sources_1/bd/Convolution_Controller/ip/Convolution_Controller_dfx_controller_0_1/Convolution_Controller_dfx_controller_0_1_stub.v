...
//               c:/GitHub/ReconHardware/FPGA_Files/Projects/ConvolutionAccel_d/ConvolutionAccel_d.srcs/sources_1/bd/Convolution_Controller/ip/Convolution_Controller_dfx_controller_0_1/Convolution_Controller_dfx_controller_0_1_stub.v
...
module Convolution_Controller_dfx_controller_0_1(m_axi_mem_araddr, m_axi_mem_arlen, 
  ...
  icap_csib, icap_rdwrb, icap_i, icap_o, vsm_MatrixAccel_rm_shutdown_req, 
  vsm_MatrixAccel_rm_shutdown_ack, vsm_MatrixAccel_rm_decouple, 
  vsm_MatrixAccel_rm_reset, vsm_MatrixAccel_event_error, 
  vsm_MatrixAccel_sw_shutdown_req, vsm_MatrixAccel_sw_startup_req, s_axi_reg_awaddr, 
  ...
  s_axi_reg_rready)
/* synthesis syn_black_box black_box_pad_pin="m_axi_mem_araddr[31:0],m_axi_mem_arlen[7:0],m_axi_mem_arsize[2:0],m_axi_mem_arburst[1:0],m_axi_mem_arprot[2:0],m_axi_mem_arcache[3:0],m_axi_mem_aruser[3:0],m_axi_mem_arvalid,m_axi_mem_arready,m_axi_mem_rdata[31:0],m_axi_mem_rresp[1:0],m_axi_mem_rlast,m_axi_mem_rvalid,m_axi_mem_rready,clk,reset,icap_clk,icap_reset,icap_csib,icap_rdwrb,icap_i[31:0],icap_o[31:0],vsm_MatrixAccel_rm_shutdown_req,vsm_MatrixAccel_rm_shutdown_ack,vsm_MatrixAccel_rm_decouple,vsm_MatrixAccel_rm_reset,vsm_MatrixAccel_event_error,vsm_MatrixAccel_sw_shutdown_req,vsm_MatrixAccel_sw_startup_req,s_axi_reg_awaddr[31:0],s_axi_reg_awvalid,s_axi_reg_awready,s_axi_reg_wdata[31:0],s_axi_reg_wvalid,s_axi_reg_wready,s_axi_reg_bresp[1:0],s_axi_reg_bvalid,s_axi_reg_bready,s_axi_reg_araddr[31:0],s_axi_reg_arvalid,s_axi_reg_arready,s_axi_reg_rdata[31:0],s_axi_reg_rresp[1:0],s_axi_reg_rvalid,s_axi_reg_rready" */;
