...
module Convolution_Controller
  ...
  wire dfx_controller_0_vsm_MatrixAccel_rm_decouple;
  ...
  Convolution_Controller_Convolution_Controll_0_0 Convolution_Controll_0
       (.MULTIPLICAND_INPUT(Convolution_Controll_0_MULTIPLICAND_INPUT),
        ...
        .m_axis_ready(Convolution_Controll_0_m_axis_data_TREADY),
        .m_axis_valid(Convolution_Controll_0_m_axis_data_TVALID),
  ...
  Convolution_Controller_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps7_0_100M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(Convolution_Controll_0_m_axis_data_TDATA),
        .s_axis_s2mm_tkeep(Convolution_Controll_0_m_axis_data_TKEEP),
  ...
  Convolution_Controller_dfx_controller_0_1 dfx_controller_0
       (.clk(processing_system7_0_FCLK_CLK0),
        ...
        .s_axi_reg_araddr(smartconnect_0_M02_AXI_ARADDR),
        .s_axi_reg_arready(smartconnect_0_M02_AXI_ARREADY),
        .s_axi_reg_arvalid(smartconnect_0_M02_AXI_ARVALID),
        .s_axi_reg_awaddr(smartconnect_0_M02_AXI_AWADDR),
        .s_axi_reg_awready(smartconnect_0_M02_AXI_AWREADY),
        .s_axi_reg_awvalid(smartconnect_0_M02_AXI_AWVALID),
        .s_axi_reg_bready(smartconnect_0_M02_AXI_BREADY),
        .s_axi_reg_bresp(smartconnect_0_M02_AXI_BRESP),
        .s_axi_reg_bvalid(smartconnect_0_M02_AXI_BVALID),
        .s_axi_reg_rdata(smartconnect_0_M02_AXI_RDATA),
        .s_axi_reg_rready(smartconnect_0_M02_AXI_RREADY),
        .s_axi_reg_rresp(smartconnect_0_M02_AXI_RRESP),
        .s_axi_reg_rvalid(smartconnect_0_M02_AXI_RVALID),
        .s_axi_reg_wdata(smartconnect_0_M02_AXI_WDATA),
        .s_axi_reg_wready(smartconnect_0_M02_AXI_WREADY),
        .s_axi_reg_wvalid(smartconnect_0_M02_AXI_WVALID),
        .vsm_MatrixAccel_rm_decouple(dfx_controller_0_vsm_MatrixAccel_rm_decouple),
        .vsm_MatrixAccel_rm_shutdown_ack(1'b1));
  ...
  Convolution_Controller_smartconnect_0_0 smartconnect_0
  ...
  Convolution_Controller_smartconnect_0_1 smartconnect_1
       (.M00_AXI_araddr(smartconnect_1_M00_AXI_ARADDR),
        ...
        .S02_AXI_aruser(dfx_controller_0_M_AXI_MEM_ARUSER),
  ...
  Convolution_Controller_util_vector_logic_0_1 util_vector_logic_1
       (.Op1(dfx_controller_0_vsm_MatrixAccel_rm_decouple),
