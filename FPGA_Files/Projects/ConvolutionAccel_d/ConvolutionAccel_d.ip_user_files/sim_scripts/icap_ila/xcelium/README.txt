...
#
# Generated by export_simulation on Thu Mar 18 19:40:38 -0500 2021
#
################################################################################
...
'-reset_run' switch to the './icap_ila.sh' script.

./icap_ila.sh -reset_run
...
./icap_ila.sh -noclean_files

For more information on the script, please type './icap_ila.sh -help'.
