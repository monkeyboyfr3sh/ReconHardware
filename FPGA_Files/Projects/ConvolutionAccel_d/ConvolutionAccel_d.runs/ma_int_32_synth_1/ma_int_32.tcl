...
namespace eval ::optrace {
  variable script "C:/GitHub/ReconHardware/FPGA_Files/Projects/ConvolutionAccel_d/ConvolutionAccel_d.runs/ma_int_32_synth_1/ma_int_32.tcl"
...
synth_design -top ma_int_32 -part xc7z020clg400-1 -mode out_of_context
OPTRACE "synth_design" END { }

rename_ref -prefix_all ma_int_32_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef ma_int_32.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "ma_int_32_synth_1_synth_report_utilization_0" "report_utilization -file ma_int_32_utilization_synth.rpt -pb ma_int_32_utilization_synth.pb"
OPTRACE "synth reports" END { }
file delete __synthesis_is_running__
close [open __synthesis_is_complete__ w]
OPTRACE "ma_int_32_synth_1" END { }
