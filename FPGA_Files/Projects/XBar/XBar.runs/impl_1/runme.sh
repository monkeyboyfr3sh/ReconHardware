...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/XBar/XBar.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log XBAR_TOP_WRAPPER.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source XBAR_TOP_WRAPPER.tcl -notrace
