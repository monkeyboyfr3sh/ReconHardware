...
proc create_root_design { parentCell } {
  ...
  set AddressSelect [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 AddressSelect ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports AddressSelect] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports direct] [get_bd_intf_pins axi_gpio_1/GPIO2]
