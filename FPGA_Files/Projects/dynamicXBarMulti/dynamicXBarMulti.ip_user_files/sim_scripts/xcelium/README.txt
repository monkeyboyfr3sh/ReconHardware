...
#
# Generated by export_simulation on Sun Jul 26 14:10:49 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './XBarMulti1multiuse_tb.sh' script.

./XBarMulti1multiuse_tb.sh -reset_run
...
./XBarMulti1multiuse_tb.sh -noclean_files

For more information on the script, please type './XBarMulti1multiuse_tb.sh -help'.
