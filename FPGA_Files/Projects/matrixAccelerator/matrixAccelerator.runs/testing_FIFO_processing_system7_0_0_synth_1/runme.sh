...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/matrixAccelerator/matrixAccelerator.runs/testing_FIFO_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testing_FIFO_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testing_FIFO_processing_system7_0_0.tcl
