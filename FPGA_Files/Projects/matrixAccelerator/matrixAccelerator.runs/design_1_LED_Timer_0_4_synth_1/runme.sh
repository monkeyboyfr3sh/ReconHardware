...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/matrixAccelerator/matrixAccelerator.runs/design_1_LED_Timer_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_LED_Timer_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_LED_Timer_0_4.tcl
