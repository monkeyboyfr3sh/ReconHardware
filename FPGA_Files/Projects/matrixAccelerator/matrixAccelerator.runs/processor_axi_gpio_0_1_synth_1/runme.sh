...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/matrixAccelerator/matrixAccelerator.runs/processor_axi_gpio_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_axi_gpio_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processor_axi_gpio_0_1.tcl
