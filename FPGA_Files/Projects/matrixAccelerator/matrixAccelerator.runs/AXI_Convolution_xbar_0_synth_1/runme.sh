...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/matrixAccelerator/matrixAccelerator.runs/AXI_Convolution_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Convolution_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Convolution_xbar_0.tcl
