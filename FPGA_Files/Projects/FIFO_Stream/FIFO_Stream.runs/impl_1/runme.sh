...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/FIFO_Stream/FIFO_Stream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_Stream_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FIFO_Stream_wrapper.tcl -notrace
