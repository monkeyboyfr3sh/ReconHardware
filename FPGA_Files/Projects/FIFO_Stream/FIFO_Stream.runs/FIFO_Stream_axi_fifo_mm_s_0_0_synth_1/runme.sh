...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/FIFO_Stream/FIFO_Stream.runs/FIFO_Stream_axi_fifo_mm_s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_Stream_axi_fifo_mm_s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_Stream_axi_fifo_mm_s_0_0.tcl
