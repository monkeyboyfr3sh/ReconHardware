...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/dynamicMulti/dynamicMulti.runs/child_2_impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_Processor_Wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplier_Processor_Wrapper.tcl -notrace
