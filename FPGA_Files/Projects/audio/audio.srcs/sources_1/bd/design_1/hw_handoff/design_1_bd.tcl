...
proc create_root_design { parentCell } {
  ...
  # Create instance: audio_interpreter_0, and set properties
  set block_name audio_interpreter
  set block_cell_name audio_interpreter_0
  if { [catch {set audio_interpreter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $audio_interpreter_0 eq "" } {
  ...
  connect_bd_net -net audio_interpreter_0_leds [get_bd_ports leds_0] [get_bd_pins audio_interpreter_0/leds]
  connect_bd_net -net audio_interpreter_0_t_ready [get_bd_pins audio_interpreter_0/t_ready] [get_bd_pins xadc_wiz_0/m_axis_tready]
  connect_bd_net -net convst_in_0_1 [get_bd_ports convst_in_0] [get_bd_pins xadc_wiz_0/convst_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins audio_interpreter_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins xadc_wiz_0/m_axis_aclk] [get_bd_pins xadc_wiz_0/s_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins xadc_wiz_0/m_axis_resetn]
  connect_bd_net -net xadc_wiz_0_m_axis_tdata [get_bd_pins audio_interpreter_0/t_data] [get_bd_pins xadc_wiz_0/m_axis_tdata]
  connect_bd_net -net xadc_wiz_0_m_axis_tvalid [get_bd_pins audio_interpreter_0/t_valid] [get_bd_pins xadc_wiz_0/m_axis_tvalid]
