...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/pr_shifter/pr_shifter.runs/design_2_smartconnect_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_smartconnect_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_smartconnect_0_1.tcl
