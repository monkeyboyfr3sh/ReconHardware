...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/pr_shifter/pr_shifter.runs/icap_ila_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log icap_ila_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source icap_ila_ila_0_0.tcl
