...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/pr_shifter/pr_shifter.runs/design_2_dfx_s_ila_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_dfx_s_ila_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_dfx_s_ila_1_0.tcl
