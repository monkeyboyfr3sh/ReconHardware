...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/Static_Convolution_Accelerator/Static_Convolution_Accelerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Conv_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI_Conv_wrapper.tcl -notrace
