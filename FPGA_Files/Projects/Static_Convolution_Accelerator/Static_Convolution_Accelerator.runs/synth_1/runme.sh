...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/Static_Convolution_Accelerator/Static_Convolution_Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Conv_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Conv_wrapper.tcl
