...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/PYNQ-HelloWorld-master/PYNQ-HelloWorld-master/boards/Pynq-Z2/resizer/resizer/resizer.runs/resizer_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log resizer_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source resizer_xbar_2.tcl
