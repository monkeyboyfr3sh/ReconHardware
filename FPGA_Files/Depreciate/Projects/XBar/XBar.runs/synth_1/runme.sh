...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/XBar/XBar.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log XBAR_TOP_WRAPPER.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source XBAR_TOP_WRAPPER.tcl
