...
HD_PWD='C:/Users/monke/Downloads/imageFilterIP-master/imageFilterIP-master/inverter/inverter.runs/dmaSystem_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmaSystem_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmaSystem_xbar_2.tcl
