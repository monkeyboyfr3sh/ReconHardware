...
module bd_dfc6
  ...
  bd_dfc6_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe36(net_slot_1_axi_awaddr),
        .probe37(net_slot_1_axi_awcache),
        .probe38(net_slot_1_axi_awlen),
        .probe39(net_slot_1_axi_awprot),
        .probe4(net_slot_0_axi_arlen),
        .probe40(net_slot_1_axi_awsize),
        .probe41(net_slot_1_axi_b_cnt),
        .probe42(net_slot_1_axi_r_cnt),
        .probe43(net_slot_1_axi_rdata),
        .probe44(net_slot_1_axi_rresp),
        .probe45(net_slot_1_axi_wdata),
        .probe46(net_slot_1_axi_aw_ctrl),
        .probe47(net_slot_1_axi_w_ctrl),
        .probe48(net_slot_1_axi_b_ctrl),
        .probe49(net_slot_1_axi_ar_ctrl),
        .probe5(net_slot_0_axi_arprot),
        .probe50(net_slot_1_axi_r_ctrl),
        .probe51(net_slot_2_axi_ar_cnt),
        .probe52(net_slot_2_axi_araddr),
        .probe53(net_slot_2_axi_arcache),
        .probe54(net_slot_2_axi_arlen),
        .probe55(net_slot_2_axi_arprot),
        .probe56(net_slot_2_axi_arsize),
        .probe57(net_slot_2_axi_aw_cnt),
        .probe58(net_slot_2_axi_awaddr),
        .probe59(net_slot_2_axi_awcache),
        .probe6(net_slot_0_axi_arsize),
        .probe60(net_slot_2_axi_awlen),
        .probe61(net_slot_2_axi_awprot),
        .probe62(net_slot_2_axi_awsize),
        .probe63(net_slot_2_axi_b_cnt),
        .probe64(net_slot_2_axi_bresp),
        .probe65(net_slot_2_axi_r_cnt),
        .probe66(net_slot_2_axi_rdata),
        .probe67(net_slot_2_axi_wdata),
        .probe68(net_slot_2_axi_wstrb),
        .probe69(net_slot_2_axi_aw_ctrl),
        .probe7(net_slot_0_axi_aw_cnt),
        .probe70(net_slot_2_axi_w_ctrl),
        .probe71(net_slot_2_axi_b_ctrl),
        .probe72(net_slot_2_axi_ar_ctrl),
        .probe73(net_slot_2_axi_r_ctrl),
        .probe74(net_slot_3_axis_tdata),
        .probe75(net_slot_3_axis_tkeep),
        .probe76(net_slot_3_axis_tvalid),
        .probe77(net_slot_3_axis_tready),
        .probe78(net_slot_3_axis_tlast),
