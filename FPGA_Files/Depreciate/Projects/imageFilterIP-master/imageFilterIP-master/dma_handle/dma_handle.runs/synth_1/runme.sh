...
HD_PWD='C:/Users/monke/Downloads/imageFilterIP-master/imageFilterIP-master/dma_handle/dma_handle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_FIFO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_FIFO_wrapper.tcl
