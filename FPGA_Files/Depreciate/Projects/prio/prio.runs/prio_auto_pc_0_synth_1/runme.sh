...
HD_PWD='C:/Users/monke/Downloads/PYNQ-PRIO-master/PYNQ-PRIO-master/boards/Pynq-Z1/prio/prio/prio.runs/prio_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prio_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prio_auto_pc_0.tcl
