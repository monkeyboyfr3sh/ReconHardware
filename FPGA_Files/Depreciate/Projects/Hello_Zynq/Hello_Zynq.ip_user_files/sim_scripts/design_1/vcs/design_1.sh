...
#
# Generated by Vivado on Sat Sep 26 17:28:21 -0500 2020
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_6 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/dc12/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_8 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/2d50/hdl" +incdir+"$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ip/design_1_processing_system7_0_0" +incdir+"C:/Xilinx/Vivado/2019.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../Hello_Zynq.srcs/sources_1/bd/design_1/ipshared/2d50/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log
