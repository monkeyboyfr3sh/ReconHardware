...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/Pixel_Controller/Pixel_Controller.runs/Pixel_Controller_BD_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pixel_Controller_BD_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pixel_Controller_BD_xbar_1.tcl
