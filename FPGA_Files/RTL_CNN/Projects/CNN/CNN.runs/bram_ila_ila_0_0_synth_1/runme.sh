...
HD_PWD='D:/GitHub/ReconHardware/FPGA_Files/RTL_CNN/Projects/CNN/CNN.runs/bram_ila_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_ila_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_ila_ila_0_0.tcl
