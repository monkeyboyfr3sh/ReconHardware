...
HD_PWD='D:/GitHub/ReconHardware/FPGA_Files/RTL_CNN/Projects/fc_layer/fc_layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FC_Module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FC_Module.tcl
