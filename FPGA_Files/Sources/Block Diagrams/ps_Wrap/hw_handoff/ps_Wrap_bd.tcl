...
proc create_root_design { parentCell } {
  ...
  set bufferOutput0 [ create_bd_port -dir O -from 15 -to 0 bufferOutput0 ]
  set bufferOutput1 [ create_bd_port -dir O -from 15 -to 0 bufferOutput1 ]
  ...
  set product_SHORT [ create_bd_port -dir O -from 15 -to 0 product_SHORT ]
