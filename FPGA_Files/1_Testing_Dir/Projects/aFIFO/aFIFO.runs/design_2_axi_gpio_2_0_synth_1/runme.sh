...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/aFIFO/aFIFO.runs/design_2_axi_gpio_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axi_gpio_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axi_gpio_2_0.tcl
