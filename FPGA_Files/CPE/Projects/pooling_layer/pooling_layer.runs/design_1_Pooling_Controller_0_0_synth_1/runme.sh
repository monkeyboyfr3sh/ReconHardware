...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/CPE/Projects/pooling_layer/pooling_layer.runs/design_1_Pooling_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Pooling_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Pooling_Controller_0_0.tcl
