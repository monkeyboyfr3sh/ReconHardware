...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_clkrst_cnt=6,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]Pooling_Controller_0_m_axis_data_TDATA;
  wire [3:0]Pooling_Controller_0_m_axis_data_TKEEP;
  wire Pooling_Controller_0_m_axis_data_TLAST;
  wire Pooling_Controller_0_m_axis_data_TREADY;
  wire Pooling_Controller_0_m_axis_data_TVALID;
  ...
  design_1_Pooling_Controller_0_0 Pooling_Controller_0
       (.axi_clk(processing_system7_0_FCLK_CLK0),
        .axi_reset_n(processing_system7_0_FCLK_CLK0),
        .m_axis_data(Pooling_Controller_0_m_axis_data_TDATA),
        .m_axis_keep(Pooling_Controller_0_m_axis_data_TKEEP),
        .m_axis_last(Pooling_Controller_0_m_axis_data_TLAST),
        .m_axis_ready(Pooling_Controller_0_m_axis_data_TREADY),
        .m_axis_valid(Pooling_Controller_0_m_axis_data_TVALID),
  ...
  design_1_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps7_0_100M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(Pooling_Controller_0_m_axis_data_TDATA),
        .s_axis_s2mm_tkeep(Pooling_Controller_0_m_axis_data_TKEEP),
        .s_axis_s2mm_tlast(Pooling_Controller_0_m_axis_data_TLAST),
        .s_axis_s2mm_tready(Pooling_Controller_0_m_axis_data_TREADY),
        .s_axis_s2mm_tvalid(Pooling_Controller_0_m_axis_data_TVALID));
