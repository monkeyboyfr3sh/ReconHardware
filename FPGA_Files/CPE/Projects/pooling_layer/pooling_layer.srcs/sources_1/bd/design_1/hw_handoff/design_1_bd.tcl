...
proc create_root_design { parentCell } {
  ...
  # Create instance: Pooling_Controller_0, and set properties
  set Pooling_Controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Pooling_Controller:1.0 Pooling_Controller_0 ]
  ...
  connect_bd_intf_net -intf_net Pooling_Controller_0_m_axis_data [get_bd_intf_pins Pooling_Controller_0/m_axis_data] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins Pooling_Controller_0/s_axis_data] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M01_AXI [get_bd_intf_pins Pooling_Controller_0/s_axi] [get_bd_intf_pins smartconnect_1/M01_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Pooling_Controller_0/axi_clk] [get_bd_pins Pooling_Controller_0/axi_reset_n] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_1/aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Pooling_Controller_0/s_axi/reg0] -force
