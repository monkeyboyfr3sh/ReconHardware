...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/ConvolutionAccel_d/ConvolutionAccel_d.runs/Convolution_Controller_snooper_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Convolution_Controller_snooper_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Convolution_Controller_snooper_0_1.tcl
