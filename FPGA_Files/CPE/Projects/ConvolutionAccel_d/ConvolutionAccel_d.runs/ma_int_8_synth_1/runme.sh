...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/ConvolutionAccel_d/ConvolutionAccel_d.runs/ma_int_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ma_int_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ma_int_8.tcl
