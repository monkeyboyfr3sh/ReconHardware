...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/CPE/Projects/bram_lb/bram_lb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_coupler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_coupler.tcl
