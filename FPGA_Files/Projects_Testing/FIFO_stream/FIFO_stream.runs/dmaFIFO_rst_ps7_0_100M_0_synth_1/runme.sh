...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/FIFO_stream/FIFO_stream.runs/dmaFIFO_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmaFIFO_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmaFIFO_rst_ps7_0_100M_0.tcl
