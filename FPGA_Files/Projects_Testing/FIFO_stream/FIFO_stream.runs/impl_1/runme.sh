...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/FIFO_stream/FIFO_stream.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dmaFIFO_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dmaFIFO_wrapper.tcl -notrace
