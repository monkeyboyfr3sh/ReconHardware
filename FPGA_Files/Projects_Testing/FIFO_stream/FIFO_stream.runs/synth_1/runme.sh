...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/FIFO_stream/FIFO_stream.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmaFIFO_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmaFIFO_wrapper.tcl
