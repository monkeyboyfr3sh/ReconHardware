...
EAStep vivado -log Pixel_Controller_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Pixel_Controller_BD_wrapper.tcl -notrace
