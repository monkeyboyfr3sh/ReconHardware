...
HD_PWD='C:/Users/monke/Downloads/imageFilterIP-master/imageFilterIP-master/dma_handle/dma_handle.runs/dma_FIFO_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_FIFO_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_FIFO_rst_ps7_0_100M_0.tcl
