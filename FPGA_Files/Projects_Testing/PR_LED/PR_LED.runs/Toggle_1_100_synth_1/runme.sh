...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/PR_LED/PR_LED.runs/Toggle_1_100_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Toggle_1_100.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Toggle_1_100.tcl
