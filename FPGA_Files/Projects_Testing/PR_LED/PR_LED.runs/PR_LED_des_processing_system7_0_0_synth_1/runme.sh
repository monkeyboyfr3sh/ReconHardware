...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/PR_LED/PR_LED.runs/PR_LED_des_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PR_LED_des_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PR_LED_des_processing_system7_0_0.tcl
