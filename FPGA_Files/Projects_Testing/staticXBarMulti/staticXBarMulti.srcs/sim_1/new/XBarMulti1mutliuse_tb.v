...
module XBarMulti1multiuse_tb;

//Inputs
reg     Clk,Rst;
reg     bufferSelect;                               //For all multipliers, select buffer0 or buffer1
reg     mStart_in;                                  //Start multiplication for multipliers that input to the xbar
reg     mStart_out;                                 //Start multiplication for multipliers that xbar outputs to
reg     [`inputPortCount-1:0]       bufferRD_in;    //bufferRD for multipliers that input to the xbar
reg     [`outputPortCount-1:0]      bufferRD_out;   //bufferRD for multipliers that xbar outputs to
reg     [`bitLength-1:0]            dataIn;         //Input to multipliers on the left of xbar
