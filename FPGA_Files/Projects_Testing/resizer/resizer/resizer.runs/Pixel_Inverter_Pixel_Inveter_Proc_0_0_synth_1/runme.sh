...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/resizer/resizer/resizer.runs/Pixel_Inverter_Pixel_Inveter_Proc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pixel_Inverter_Pixel_Inveter_Proc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pixel_Inverter_Pixel_Inveter_Proc_0_0.tcl
