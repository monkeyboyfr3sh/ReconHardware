...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects_Testing/resizer/resizer/resizer.runs/FIFO_stream_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_stream_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_stream_processing_system7_0_0.tcl
