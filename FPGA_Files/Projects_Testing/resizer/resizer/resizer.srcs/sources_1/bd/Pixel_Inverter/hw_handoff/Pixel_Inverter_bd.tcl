...
################################################################
# This is a generated script based on design: Pixel_Inverter
#
...
# source Pixel_Inverter_script.tcl
...
set design_name Pixel_Inverter
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Pixel_Inveter_Proc_0, and set properties
  set Pixel_Inveter_Proc_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Pixel_Inveter_Proc:1.0 Pixel_Inveter_Proc_0 ]
  ...
  connect_bd_intf_net -intf_net Pixel_Inveter_Proc_0_m_axis [get_bd_intf_pins Pixel_Inveter_Proc_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins Pixel_Inveter_Proc_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Pixel_Inveter_Proc_0/axi_reset_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
