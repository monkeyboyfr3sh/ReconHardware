...
#
# Generated by export_simulation on Fri Dec 04 14:19:30 -0600 2020
#
################################################################################
...
'-reset_run' switch to the './axi_fifo_mm_s_0.sh' script.

./axi_fifo_mm_s_0.sh -reset_run
...
./axi_fifo_mm_s_0.sh -noclean_files

For more information on the script, please type './axi_fifo_mm_s_0.sh -help'.
