...
vlog -work xpm  -incr -sv "+incdir+../../../ipstatic/hdl/src/verilog" \
...
vlog -work dist_mem_gen_v8_0_13  -incr "+incdir+../../../ipstatic/hdl/src/verilog" \
"../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \

vlog -work blk_mem_gen_v8_4_4  -incr "+incdir+../../../ipstatic/hdl/src/verilog" \
...
vlog -work axi_traffic_gen_v3_0_7  -incr "+incdir+../../../ipstatic/hdl/src/verilog" \
"../../../ipstatic/hdl/axi_traffic_gen_v3_0_rfs.v" \

vlog -work xil_defaultlib  -incr "+incdir+../../../ipstatic/hdl/src/verilog" \
