...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/simple_axis_dma/simple_axis_dma.runs/design_1_Pixel_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Pixel_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Pixel_Controller_0_0.tcl
