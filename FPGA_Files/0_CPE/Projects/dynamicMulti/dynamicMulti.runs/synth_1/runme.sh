...
HD_PWD='C:/GitHub/ReconHardware/FPGA_Files/Projects/dynamicMulti/dynamicMulti.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_Processor_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Multiplier_Processor_Wrapper.tcl
