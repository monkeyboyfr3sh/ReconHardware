...
proc create_root_design { parentCell } {
  ...
  set bufferOutput [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 bufferOutput ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports io_clk] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports Rst] [get_bd_intf_pins axi_gpio_0/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports bufferInput] [get_bd_intf_pins axi_gpio_1/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports cStart] [get_bd_intf_pins axi_gpio_2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO2 [get_bd_intf_ports newline] [get_bd_intf_pins axi_gpio_2/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO [get_bd_intf_ports wr] [get_bd_intf_pins axi_gpio_3/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO2 [get_bd_intf_ports rd] [get_bd_intf_pins axi_gpio_3/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_4_GPIO [get_bd_intf_ports bufferOutput] [get_bd_intf_pins axi_gpio_4/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_5_GPIO [get_bd_intf_ports FULL_in] [get_bd_intf_pins axi_gpio_5/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_5_GPIO2 [get_bd_intf_ports EMPTY_in] [get_bd_intf_pins axi_gpio_5/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_6_GPIO [get_bd_intf_ports FULL_out] [get_bd_intf_pins axi_gpio_6/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_6_GPIO2 [get_bd_intf_ports EMPTY_out] [get_bd_intf_pins axi_gpio_6/GPIO2]
