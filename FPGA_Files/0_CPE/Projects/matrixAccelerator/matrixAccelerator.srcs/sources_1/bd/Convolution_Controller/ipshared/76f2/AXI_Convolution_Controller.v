...
module Convolution_Controller#(
    ...
    input    cReady,
    output reg [`inputPortCount*`bitLength-1:0] MULTIPLIER_INPUT,   //Flat output for data set
    output reg [`inputPortCount*`bitLength-1:0] MULTIPLICAND_INPUT, //Flat output for filter set
    output reg [`inputPortCount-1:0] MULTIPLY_START,
    output   FINALADDOUT,
