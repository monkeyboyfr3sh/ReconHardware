...
synth_design -top integercomputeBlockPynq -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef integercomputeBlockPynq.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file integercomputeBlockPynq_utilization_synth.rpt -pb integercomputeBlockPynq_utilization_synth.pb"
