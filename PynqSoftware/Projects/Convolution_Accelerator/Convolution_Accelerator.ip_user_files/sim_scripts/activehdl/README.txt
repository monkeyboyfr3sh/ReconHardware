...
#
# Generated by export_simulation on Wed Aug 26 15:33:27 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './matrixAccTopDevice.sh' script.

./matrixAccTopDevice.sh -reset_run
...
./matrixAccTopDevice.sh -noclean_files

For more information on the script, please type './matrixAccTopDevice.sh -help'.
