...
HD_PWD='C:/GitHub/ReconHardware/PynqSoftware/Projects/Convolution_Accelerator/Convolution_Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Conv_Accel_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Conv_Accel_Top.tcl
