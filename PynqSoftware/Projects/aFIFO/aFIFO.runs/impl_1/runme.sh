...
HD_PWD='C:/GitHub/ReconHardware/PynqSoftware/Projects/aFIFO/aFIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BUF_WRAP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BUF_WRAP.tcl -notrace
