...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net aFIFO_0_dataOut [get_bd_pins aFIFO_0/dataOut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net aFIFO_0_o_rempty [get_bd_pins aFIFO_0/o_rempty] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net aFIFO_0_o_wfull [get_bd_pins aFIFO_0/o_wfull] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net rclk_Dout [get_bd_pins aFIFO_0/i_rclk] [get_bd_pins rclk/Dout]
  connect_bd_net -net rd_Dout [get_bd_pins aFIFO_0/i_rd] [get_bd_pins rd/Dout]
  connect_bd_net -net rrst_Dout [get_bd_pins aFIFO_0/i_rrst_n] [get_bd_pins rrst/Dout]
  connect_bd_net -net wclk_Dout [get_bd_pins aFIFO_0/i_wclk] [get_bd_pins wclk/Dout]
  connect_bd_net -net wdata_Dout [get_bd_pins aFIFO_0/i_wdata] [get_bd_pins wdata/Dout]
  connect_bd_net -net wr_Dout [get_bd_pins aFIFO_0/i_wr] [get_bd_pins wr/Dout]
  connect_bd_net -net wrst_Dout [get_bd_pins aFIFO_0/i_wrst_n] [get_bd_pins wrst/Dout]
