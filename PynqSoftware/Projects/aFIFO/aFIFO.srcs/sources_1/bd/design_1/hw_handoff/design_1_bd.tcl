...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins dataIn/Din] [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins rd_clk/Din] [get_bd_pins rst/Din] [get_bd_pins wr_clk/Din]
  connect_bd_net -net rd_clk1_Dout [get_bd_pins aFIFO_0/Rst] [get_bd_pins rst/Dout]
