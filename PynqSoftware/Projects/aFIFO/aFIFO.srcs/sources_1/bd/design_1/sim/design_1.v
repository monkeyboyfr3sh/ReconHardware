...
module design_1
  ...
  wire aFIFO_0_o_rempty;
  wire aFIFO_0_o_wfull;
  ...
  design_1_aFIFO_0_0 aFIFO_0
       (.dataOut(aFIFO_0_dataOut),
        ...
        .i_wr(wr_Dout),
        .i_wrst_n(wrst_Dout),
        .o_rempty(aFIFO_0_o_rempty),
        .o_wfull(aFIFO_0_o_wfull));
  ...
  design_1_xlslice_3_0 rclk
       (.Din(processing_system7_0_GPIO_O),
        .Dout(rclk_Dout));
  design_1_xlslice_5_0 rd
       (.Din(processing_system7_0_GPIO_O),
        .Dout(rd_Dout));
  design_1_xlslice_4_0 rrst
       (.Din(processing_system7_0_GPIO_O),
        .Dout(rrst_Dout));
  design_1_xlslice_0_0 wclk
       (.Din(processing_system7_0_GPIO_O),
        .Dout(wclk_Dout));
  design_1_xlslice_2_0 wdata
       (.Din(processing_system7_0_GPIO_O),
        .Dout(wdata_Dout));
  design_1_xlslice_1_0 wr
       (.Din(processing_system7_0_GPIO_O),
        .Dout(wr_Dout));
  design_1_xlslice_0_1 wrst
       (.Din(processing_system7_0_GPIO_O),
        .Dout(wrst_Dout));
  design_1_xlconcat_0_0 xlconcat_0
       (.In0(aFIFO_0_o_wfull),
        .In1(aFIFO_0_dataOut),
        .In2(aFIFO_0_o_rempty),
