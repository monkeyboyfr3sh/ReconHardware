...
proc create_root_design { parentCell } {
  ...
  # Create instance: aFIFO_0, and set properties
  set block_name aFIFO
  set block_cell_name aFIFO_0
  if { [catch {set aFIFO_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_GPIO_EMIO_GPIO_IO {36} \
   CONFIG.PCW_GPIO_EMIO_GPIO_WIDTH {36} \
  ...
  # Create instance: rd_clk, and set properties
  set rd_clk [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 rd_clk ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {18} \
   CONFIG.DIN_TO {18} \
   CONFIG.DIN_WIDTH {36} \
  ...
  connect_bd_net -net aFIFO_0_EMPTY [get_bd_pins aFIFO_0/EMPTY] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net aFIFO_0_FULL [get_bd_pins aFIFO_0/FULL] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net aFIFO_0_dataOut [get_bd_pins aFIFO_0/dataOut] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins aFIFO_0/Rst] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins dataIn/Din] [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins rd_clk/Din] [get_bd_pins wr_clk/Din]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/GPIO_I] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins aFIFO_0/dataIn] [get_bd_pins dataIn/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins aFIFO_0/wr_clk] [get_bd_pins wr_clk/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins aFIFO_0/rd_clk] [get_bd_pins rd_clk/Dout]
