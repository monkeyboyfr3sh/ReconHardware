...
(* CORE_GENERATION_INFO = "fifo,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=fifo,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "fifo.hwdef" *) 
module fifo
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  fifo_xlslice_0_2 xlslice_0
       (.Din(processing_system7_0_GPIO_O),
        .Dout(xlslice_0_Dout));
  fifo_xlslice_1_1 xlslice_1
       (.Din(processing_system7_0_GPIO_O),
        .Dout(xlslice_1_Dout));
