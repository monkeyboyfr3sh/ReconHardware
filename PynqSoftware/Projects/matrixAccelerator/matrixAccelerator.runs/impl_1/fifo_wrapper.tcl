...
set rc [catch {
  ...
  open_checkpoint fifo_wrapper_routed.dcp
  ...
  catch { write_mem_info -force fifo_wrapper.mmi }
  write_bitstream -force fifo_wrapper.bit 
  catch {write_debug_probes -quiet -force fifo_wrapper}
  catch {file copy -force fifo_wrapper.ltx debug_nets.ltx}
