...
synth_design -top Convolution_Accel_wrapper -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef Convolution_Accel_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Convolution_Accel_wrapper_utilization_synth.rpt -pb Convolution_Accel_wrapper_utilization_synth.pb"
