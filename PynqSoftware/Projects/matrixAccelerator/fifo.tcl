...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins aFIFO_0/Clk] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins aFIFO_0/dataIn] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins aFIFO_0/wr_clk] [get_bd_pins xlslice_2/Dout]
