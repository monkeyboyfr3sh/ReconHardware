...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_6 -L processing_system7_vip_v1_0_8 -L xlconcat_v2_1_3 -L xlslice_v1_0_2 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo xil_defaultlib.fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo -key {Behavioral:sim_1:Functional:fifo} -tclbatch cmd.tcl -protoinst "protoinst_files/fifo.protoinst" -protoinst "protoinst_files/Convolution_Accel.protoinst" -log simulate.log
}
