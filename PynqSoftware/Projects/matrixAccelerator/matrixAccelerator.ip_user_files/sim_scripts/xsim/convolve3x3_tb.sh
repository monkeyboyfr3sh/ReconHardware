...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot convolve3x3_tb xil_defaultlib.convolve3x3_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim convolve3x3_tb -key {Behavioral:sim_1:Functional:convolve3x3_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/PYNQ_wrap.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb convolve3x3_tb.wdb xsim.dir)
