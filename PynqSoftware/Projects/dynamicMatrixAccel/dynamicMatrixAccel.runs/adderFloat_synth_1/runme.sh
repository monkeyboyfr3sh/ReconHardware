...
HD_PWD='C:/Users/monke/Documents/GitHub/ReconHardware/PynqSoftware/Projects/dynamicMatrixAccel/dynamicMatrixAccel.runs/adderFloat_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adderFloat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adderFloat.tcl
