...
HD_PWD='C:/Users/monke/Documents/GitHub/ReconHardware/PynqSoftware/dynamicMulti/dynamicMulti.runs/child_3_impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamicMulti.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dynamicMulti.tcl -notrace
