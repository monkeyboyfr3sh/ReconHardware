...
HD_PWD='C:/Users/monke/Documents/GitHub/ReconHardware/PynqSoftware/dynamicMulti/dynamicMulti.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dynamicMulti.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dynamicMulti.tcl
