...
//Command     : generate_target pbuffer_splitter_wrapper.bd
//Design      : pbuffer_splitter_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "pbuffer_splitter_wrapper,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pbuffer_splitter_wrapper,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "pbuffer_splitter_wrapper.hwdef" *) 
module pbuffer_splitter_wrapper
   (Clk,
    Clr,
    DDR_addr,
    DDR_ba,
    ...
    product_LONG,
    product_SHORT);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_RESET Rst, CLK_DOMAIN pbuffer_splitter_wrapper_Clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input Clk;
  input Clr;
  ...
  assign dataIn_0_1 = product_LONG[7:0];
  assign dataIn_1_1 = dataIn[3:0];
  assign product_SHORT[3:0] = dataSplit_0_dataOut;
  pbuffer_splitter_wrapper_ParallelBuffer_0_0 ParallelBuffer_0
       (.CLR(CLR_0_1),
        .Clk(Clk_0_1),
        .EN(EN_0_1),
  ...
  pbuffer_splitter_wrapper_dataSplit_0_0 dataSplit_0
       (.Clk(Clk_0_1),
        .RD(CLR_0_1),
        .Rst(Rst_0_1),
  ...
  pbuffer_splitter_wrapper_processing_system7_0_0 processing_system7_0
