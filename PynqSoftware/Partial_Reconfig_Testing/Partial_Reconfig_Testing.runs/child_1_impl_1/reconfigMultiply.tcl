...
set rc [catch {
  ...
  write_bitstream -force -cell mCompute mCompute_floatPynq_partial.bit 
  ...
  catch {write_debug_probes -quiet -force -cell mCompute -file mCompute_floatPynq_partial.ltx}
