...
set rc [catch {
  ...
  write_bitstream -force -cell mCompute mCompute_integerPynq_partial.bit 
  ...
  catch {write_debug_probes -quiet -force -cell mCompute -file mCompute_integerPynq_partial.ltx}
