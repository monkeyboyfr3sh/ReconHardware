...
proc create_root_design { parentCell } {
  ...
  set RD [ create_bd_port -dir I RD ]
  ...
  set dataInput [ create_bd_port -dir I -from 3 -to 0 dataInput ]
  set data_clr [ create_bd_port -dir I data_clr ]
  ...
  connect_bd_net -net CLR_0_1 [get_bd_ports data_clr] [get_bd_pins ParallelBuffer_0/CLR] [get_bd_pins dataSplit_0/RD]
  connect_bd_net -net Clk_0_1 [get_bd_ports clk] [get_bd_pins ParallelBuffer_0/Clk] [get_bd_pins dataSplit_0/Clk]
  connect_bd_net -net EN_0_1 [get_bd_ports EN] [get_bd_pins ParallelBuffer_0/EN]
  ...
  connect_bd_net -net RD_0_1 [get_bd_ports RD] [get_bd_pins ParallelBuffer_0/RD]
  ...
  connect_bd_net -net dataIn_0_1 [get_bd_ports dataInput] [get_bd_pins ParallelBuffer_0/dataIn]
