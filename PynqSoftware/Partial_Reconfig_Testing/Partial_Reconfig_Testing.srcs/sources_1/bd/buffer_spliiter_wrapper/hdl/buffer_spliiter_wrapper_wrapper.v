...
//Command     : generate_target buffer_spliiter_wrapper_wrapper.bd
//Design      : buffer_spliiter_wrapper_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module buffer_spliiter_wrapper_wrapper
   (CLR,
    Clk,
    FULL0,
    FULL1,
  ...
  buffer_spliiter_wrapper buffer_spliiter_wrapper_i
       (.CLR(CLR),
        .Clk(Clk),
        .FULL0(FULL0),
        .FULL1(FULL1),
