...
//Date        : Wed Jun 24 20:56:46 2020
//Host        : DESKTOP-D9F9TPQ running 64-bit major release  (build 9200)
//Command     : generate_target buffer_spliiter_wrapper.bd
//Design      : buffer_spliiter_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "buffer_spliiter_wrapper,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=buffer_spliiter_wrapper,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "buffer_spliiter_wrapper.hwdef" *) 
module buffer_spliiter_wrapper
   (CLR,
    Clk,
    FULL0,
    FULL1,
    ...
    product_SHORT);
  input CLR;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_RESET Rst, CLK_DOMAIN buffer_spliiter_wrapper_Clk_0, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input Clk;
  output FULL0;
  output FULL1;
  ...
  buffer_spliiter_wrapper_ParallelBuffer_0_0 ParallelBuffer_0
       (.CLR(CLR_0_1),
        .Clk(Clk_0_1),
        .EN(EN_0_1),
  ...
  buffer_spliiter_wrapper_dataSplit_0_0 dataSplit_0
       (.Clk(Clk_0_1),
        .RD(CLR_0_1),
        .Rst(Rst_0_1),
