...
HD_PWD='C:/Users/monke/Documents/GitHub/ReconHardware/PynqSoftware/Multiplier/Multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pBuffer_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pBuffer_wrapper.tcl -notrace
