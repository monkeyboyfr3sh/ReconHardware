...
--               c:/Users/monke/Documents/GitHub/ReconHardware/PynqSoftware/Multiplier/Multiplier.srcs/sources_1/bd/pBuffer/ip/pBuffer_ParallelBuffer_0_0/pBuffer_ParallelBuffer_0_0_sim_netlist.vhdl
...
entity pBuffer_ParallelBuffer_0_0_SingleBuffer is
  port (
    FULL0 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of pBuffer_ParallelBuffer_0_0_SingleBuffer : entity is "SingleBuffer";
end pBuffer_ParallelBuffer_0_0_SingleBuffer;

architecture STRUCTURE of pBuffer_ParallelBuffer_0_0_SingleBuffer is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pBuffer_ParallelBuffer_0_0_SingleBuffer_0 is
  port (
    FULL1 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of pBuffer_ParallelBuffer_0_0_SingleBuffer_0 : entity is "SingleBuffer";
end pBuffer_ParallelBuffer_0_0_SingleBuffer_0;

architecture STRUCTURE of pBuffer_ParallelBuffer_0_0_SingleBuffer_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pBuffer_ParallelBuffer_0_0_ParallelBuffer is
  port (
    dataOut0 : out STD_LOGIC_VECTOR ( 3 downto 0 );
    dataOut1 : out STD_LOGIC_VECTOR ( 3 downto 0 );
    FULL1 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of pBuffer_ParallelBuffer_0_0_ParallelBuffer : entity is "ParallelBuffer";
end pBuffer_ParallelBuffer_0_0_ParallelBuffer;

architecture STRUCTURE of pBuffer_ParallelBuffer_0_0_ParallelBuffer is
  signal p_0_in : STD_LOGIC;
begin
buff0: entity work.pBuffer_ParallelBuffer_0_0_SingleBuffer
     port map (
      CLR => CLR,
      Clk => Clk,
      EN => EN,
...
buff1: entity work.pBuffer_ParallelBuffer_0_0_SingleBuffer_0
     port map (
      CLR => CLR,
      Clk => Clk,
      EN => EN,
...
entity pBuffer_ParallelBuffer_0_0 is
  ...
  attribute NotValidForBitStream of pBuffer_ParallelBuffer_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of pBuffer_ParallelBuffer_0_0 : entity is "pBuffer_ParallelBuffer_0_0,ParallelBuffer,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of pBuffer_ParallelBuffer_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of pBuffer_ParallelBuffer_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of pBuffer_ParallelBuffer_0_0 : entity is "ParallelBuffer,Vivado 2019.2";
end pBuffer_ParallelBuffer_0_0;

architecture STRUCTURE of pBuffer_ParallelBuffer_0_0 is
...
begin
inst: entity work.pBuffer_ParallelBuffer_0_0_ParallelBuffer
     port map (
      CLR => CLR,
      Clk => Clk,
      EN => EN,
