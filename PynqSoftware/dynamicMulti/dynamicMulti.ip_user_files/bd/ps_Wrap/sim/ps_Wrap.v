...
(* CORE_GENERATION_INFO = "ps_Wrap,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ps_Wrap,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "ps_Wrap.hwdef" *) 
module ps_Wrap
   (Clk,
    Clr,
    DDR_addr,
  ...
  ps_Wrap_processing_system7_0_0 processing_system7_0
