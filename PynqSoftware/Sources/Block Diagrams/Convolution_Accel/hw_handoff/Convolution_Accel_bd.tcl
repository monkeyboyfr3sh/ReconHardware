...
################################################################
# This is a generated script based on design: Convolution_Accel
#
...
# source Convolution_Accel_script.tcl
...
set design_name Convolution_Accel
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net cStart_Dout [get_bd_pins cStart/Dout] [get_bd_pins matrixAccTopDevice_0/cStart]
  connect_bd_net -net dataInput_Dout [get_bd_pins dataInput/Dout] [get_bd_pins matrixAccTopDevice_0/dataInput]
  ...
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins cStart/Din] [get_bd_pins dataInput/Din] [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins wr_clk/Din]
  connect_bd_net -net wr_clk_Dout [get_bd_pins matrixAccTopDevice_0/wr_clk] [get_bd_pins wr_clk/Dout]
