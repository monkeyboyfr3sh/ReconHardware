...
#
# Generated by export_simulation on Sun Jul 26 13:14:06 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './PYNQ_wrap.sh' script.

./PYNQ_wrap.sh -reset_run
...
./PYNQ_wrap.sh -noclean_files

For more information on the script, please type './PYNQ_wrap.sh -help'.
