...
#
# Generated by export_simulation on Wed Jul 01 17:56:22 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './ps_Wrap.sh' script.

./ps_Wrap.sh -reset_run
...
./ps_Wrap.sh -noclean_files

For more information on the script, please type './ps_Wrap.sh -help'.
