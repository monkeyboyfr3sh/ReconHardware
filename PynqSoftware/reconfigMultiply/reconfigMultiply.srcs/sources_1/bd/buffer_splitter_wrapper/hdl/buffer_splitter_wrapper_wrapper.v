...
//Date        : Thu Jun 25 12:07:50 2020
//Host        : DESKTOP-D9F9TPQ running 64-bit major release  (build 9200)
//Command     : generate_target buffer_splitter_wrapper_wrapper.bd
//Design      : buffer_splitter_wrapper_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module buffer_splitter_wrapper_wrapper
   (Clk,
    Clr,
    FULL0,
    FULL1,
  ...
  buffer_splitter_wrapper buffer_splitter_wrapper_i
       (.Clk(Clk),
        .Clr(Clr),
        .FULL0(FULL0),
        .FULL1(FULL1),
