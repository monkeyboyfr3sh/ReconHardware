...
set_property DRIVE 12 [get_ports {dataOut[3]}]
set_property DRIVE 12 [get_ports {dataOut[2]}]
set_property DRIVE 12 [get_ports {dataOut[1]}]
set_property DRIVE 12 [get_ports {dataOut[0]}]
...
set_property PULLDOWN true [get_ports chunkCount]
...
set_property PULLDOWN true [get_ports {dataOut[3]}]
set_property PULLDOWN true [get_ports {dataOut[2]}]
set_property PULLDOWN true [get_ports {dataOut[1]}]
set_property PULLDOWN true [get_ports {dataOut[0]}]
...
set_property OFFCHIP_TERM NONE [get_ports dataOut[3]]
set_property OFFCHIP_TERM NONE [get_ports dataOut[2]]
set_property OFFCHIP_TERM NONE [get_ports dataOut[1]]
set_property OFFCHIP_TERM NONE [get_ports dataOut[0]]
