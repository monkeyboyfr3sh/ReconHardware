...
set rc [catch {
  ...
  update_design -cell mCompute -buffer_ports
...
set rc [catch {
  ...
  create_report "child_4_impl_1_opt_report_drc_0" "report_drc -file reconfigMultiplyBlock_drc_opted.rpt -pb reconfigMultiplyBlock_drc_opted.pb -rpx reconfigMultiplyBlock_drc_opted.rpx"
...
set rc [catch {
  ...
  create_report "child_4_impl_1_place_report_io_0" "report_io -file reconfigMultiplyBlock_io_placed.rpt"
  create_report "child_4_impl_1_place_report_utilization_0" "report_utilization -file reconfigMultiplyBlock_utilization_placed.rpt -pb reconfigMultiplyBlock_utilization_placed.pb"
  create_report "child_4_impl_1_place_report_control_sets_0" "report_control_sets -verbose -file reconfigMultiplyBlock_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "child_4_impl_1_route_report_drc_0" "report_drc -file reconfigMultiplyBlock_drc_routed.rpt -pb reconfigMultiplyBlock_drc_routed.pb -rpx reconfigMultiplyBlock_drc_routed.rpx"
  create_report "child_4_impl_1_route_report_methodology_0" "report_methodology -file reconfigMultiplyBlock_methodology_drc_routed.rpt -pb reconfigMultiplyBlock_methodology_drc_routed.pb -rpx reconfigMultiplyBlock_methodology_drc_routed.rpx"
  create_report "child_4_impl_1_route_report_power_0" "report_power -file reconfigMultiplyBlock_power_routed.rpt -pb reconfigMultiplyBlock_power_summary_routed.pb -rpx reconfigMultiplyBlock_power_routed.rpx"
  create_report "child_4_impl_1_route_report_route_status_0" "report_route_status -file reconfigMultiplyBlock_route_status.rpt -pb reconfigMultiplyBlock_route_status.pb"
  create_report "child_4_impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file reconfigMultiplyBlock_timing_summary_routed.rpt -pb reconfigMultiplyBlock_timing_summary_routed.pb -rpx reconfigMultiplyBlock_timing_summary_routed.rpx -warn_on_violation "
  create_report "child_4_impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file reconfigMultiplyBlock_incremental_reuse_routed.rpt"
  create_report "child_4_impl_1_route_report_clock_utilization_0" "report_clock_utilization -file reconfigMultiplyBlock_clock_utilization_routed.rpt"
  create_report "child_4_impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file reconfigMultiplyBlock_bus_skew_routed.rpt -pb reconfigMultiplyBlock_bus_skew_routed.pb -rpx reconfigMultiplyBlock_bus_skew_routed.rpx"
  write_checkpoint -force -cell mCompute mCompute_routed.dcp
